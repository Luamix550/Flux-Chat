...
export default function HomePage() {
  ...
  return (
    <div className="flex flex-col md:flex-row items-center max-sm:h-[1000px] max-md:h-[900px]  h-screen justify-center font-Grotesk bg-wallpaper3 bg-cover bg-center p-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-sm:h-[400px] max-sm:w-[380px] md:h-[600px] md:w-[500px] shadow-2xl backdrop-blur-3xl rounded-md p-4">
        ...
        <div className="relative flex flex-col items-center justify-center md:w-[480px] md:h-[600px] text-white max-sm:pr-[0px] max-lg:pr-[120px] bg-cover bg-center p-5 gap-5">
          
          <div className="text-7xl max-sm:text-6xl max-md:text-7xl font-Amsterdam text-center max-lg:mt-2 max-sm:mt-2 max-md:ml-2 max-lg:ml-2">
            <Typewriter
              onInit={typewriter => {
                typewriter
                  .typeString('FluxChat')
          ...
          <div className="absolute flex flex-col left-7 bottom-4 md:bottom-5 md:top-[480px]">
            <p className="mb-2 text-sm md:text-lg text-white">Developed by:</p>
